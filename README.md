...
A modern, high-performance portfolio website showcasing my journey from Chemistry Lab to Automation, Data & QA. Built with **Vanilla HTML/CSS/JS** and enhanced with a **Neon Cyan/Green** aesthetic to reflect a tech-forward mindset.
...
I am a chemist who evolved into a tech enthusiast. Starting from optimizing lab workflows with Excel VBA, I expanded my skills to **Python, SQL, Power BI, and Web Development**. I specialize in:

-   **Automation:** Reducing manual tasks by 60-80% using Python & Apps Script.
-   **Data Insights:** Creating actionable dashboards with SQL & Power BI.
...
## 🛠️ Tech Stack
This portfolio is built with responsiveness and performance in mind:
